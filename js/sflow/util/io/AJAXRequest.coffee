# sflow.util.io.AJAXRequest
# Vizme, Inc. (C)2011-2013
# Scott Ernst

#import sflow.util.Types
#import sflow.util.url.URLUtils
#import sflow.util.string.StringUtils
...
#___________________________________________________________________________________________________ constructor
    constructor: (id, scriptURI, dataType, csrfProtect) ->
        ### Creates a new instance of AJAXRequest.
            @@@param id
                Identifier for the request (or null for no identifiers)
            @@@param scriptURI
                Relative or full path to the AJAX request target. Relative paths are specified
            ...
            @@@param dataType
                Data type to be returned by the request
            @@@param callback
                Function executed as callback with signature callback(AJAXRequest).
        ###
