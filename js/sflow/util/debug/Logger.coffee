# sflow.util.debug.Logger.coffee
...
#___________________________________________________________________________________________________ active
    active: () =>
        ...
        return Types.isSet(window.console) and (
            SFLOW.CONFIG.DEBUG or (page and page.FORCE_LOG)
        )
...
#___________________________________________________________________________________________________ initialize
    initialize: () =>
        # Make the trace function globally accessible through SFLOW.trace
        SFLOW.trace = @trace
        while SFLOW.TRC.length > 0
            @trace(SFLOW.TRC.shift())
